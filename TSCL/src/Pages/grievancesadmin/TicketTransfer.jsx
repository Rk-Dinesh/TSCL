...
const TicketTransfer = (props) => {
  ...
  const onSubmit = async(data) => {
    ...
    try {
        const token = sessionStorage.getItem('token');
        const response = await axios.post(`${API}/new-grievance/tickettransfer?grievance_id=${props.transerId}`, formData,{
          headers:{
            Authorization:`Bearer ${token}`
          }
        }
        ...
        if (response.status === 200) {
          toast.success('Ticket Transfered Successfully');
          props.toggleTModal();
      ...
      <div className="border-b-2 border-gray-300 mx-6">
        ...
        <div className="  py-2 mx-6 my-3 gap-5 ">
          <div className="mb-3 flex items-baseline gap-3">
            ...
            {errors.dept_name && (
                <p className="text-red-500 text-end text-sm mb-2 -mt-2">{errors.dept_name.message}</p>
              )}
            ...
            <div className="mb-3 flex items-baseline gap-3">
              ...
              >
                ...
                <option key={com.complaint_id} value={com.complaint_type_title}>
            ...
            {errors.complaint && (
                <p className="text-red-500 text-end text-sm mb-2 -mt-2">{errors.complaint.message}</p>
              )}
