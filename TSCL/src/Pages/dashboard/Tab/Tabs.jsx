...
function Tabs({ permissions, feature }) {
  ...
  return (
    <div className="overflow-auto no-scrollbar">
      ...
      <div className="mx-1 ">
        {activeTab === "tab1" && <GrivevanceAnalyticDashboard1 feature={feature}/>}
        {activeTab === "tab2" && <WardAnalyticDashboard2 />}
        {activeTab === "tab3" && <EngineerMetrics />}
        {activeTab === "tab4" && <PredictiveAnalysis />}
      </div>
    </div>
  );
}
