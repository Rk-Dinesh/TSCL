      ...
      <div className="  font-lexend h-screen ">
        <div className="bg-white h-4/5 mx-3 rounded-lg mt-5  p-3">
          <div className="flex justify-between gap-6 mt-4 mx-3">
            <div className="flex flex-wrap gap-3">
              <p className="text-lg whitespace-nowrap">View Request</p>
            </div>
            <div className="flex gap-1 flex-wrap">
              <button className="px-3 py-1.5 text-primary hover:text-white bg-blue-100 hover:bg-primary rounded-full">
                indvidual
              </button>
              <button className="px-3 py-1.5 text-primary hover:text-white bg-blue-100 hover:bg-primary rounded-full">
                Association
          ...
          <div className=" rounded-lg  py-3 overflow-x-auto no-scrollbar">
            <table className="w-full mt-3 ">
              <thead className=" border-b border-gray-300  ">
                <tr className="">
                  <th className="">
                    <p className=" mx-6 my-4 font-lexend font-semibold whitespace-nowrap">
                      #
                    </p>
                  </th>
                  <th>
              ...
              <tbody>
                <tr className=" border-b border-gray-300  ">
                  <td>
                    <p className=" text-center mx-1.5  my-4 font-lexend whitespace-nowrap text-sm">
                      {" "}
                      1{" "}
                    </p>
                  </td>
                  ...
                  <td>
                    {" "}
                    <p className="bg-yellow-500 border-2 w-24 border-none rounded-full text-center text-white py-1.5 mx-3 text-sm">
                      High
                    </p>
                  </td>
                </tr>
        ...
        >
          <span className="text-sm font-normal text-gray-700 mb-4 md:mb-0 block w-full md:inline md:w-auto text-center font-alegerya">
            ...
            of <span className="text-gray-900">{grievance.length} entries</span>
          </span>
