...
import Grivences from "./Grievances";

function GrievanceTab({permissions}) {
  ...
  return (
    <div className="overflow-auto no-scrollbar">
      ...
      <div className="mx-1 ">
        {activeTab === "tab1" && <Grivences permissions={permissions} include={include} endpoint={'bynotclosed'} />}
        {activeTab === "tab2" &&<Grivences permissions={permissions} endpoint={'byclosed'}/>}
      </div>
    </div>
  );
}
