...
const Street = () => {
  ...
  return (
        ...
        <table className="w-full  ">
          <thead className=" border-b-2 border-gray-300">
            ...
            <tr className="border-b-2 border-gray-300">
              ...
              <th>
                <p className="mx-4 my-3 font-lexend font-semibold">Action</p>
              </th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr className="border-b-2 border-gray-300">
                <td className="">
                  <div className="items-center mx-4 my-2 font-lexend ">Street 1</div>
                </td>
                <td className="">
              ...
              <tr className="border-b-2 border-gray-300">
                <td className="">
                  <div className="items-center mx-4 my-2 font-lexend ">Street 2</div>
                </td>
                <td className="">
                  <div className="items-center mx-4 my-2 font-lexend ">Ward 1</div>
                </td>
    ...
    {isModal && <AddStreet toggleModal={toggleModal}/>}
    </Fragment>
  );
};
