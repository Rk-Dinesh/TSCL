  ...
  return (
    ...
    <div className="  bg-blue-100 h-screen">
      ...
      <div className="flex justify-between my-2 mx-8">
        <h1 className="text-2xl font-medium ml-8 mt-1 items-center font-lexend">PublicUser Details</h1>
        <a href="#">
      ...
      <div className="bg-white mx-10 my-5 rounded-lg overflow-x-auto">
       ...
       <tr className="border-b-2 border-gray-300">
              ...
              <th>
                <div className="flex gap-2 items-center mx-4  my-2 font-lexend font-semibold whitespace-nowrap">
                Verification Status<RiExpandUpDownLine />
                </div>
              </th>
              <th>
     ...
     {isModal && <AddUser toggleModal={toggleModal} />}
    </Fragment>
  )
}
