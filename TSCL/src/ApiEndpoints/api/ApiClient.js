...
const API_ENDPOINTS = {
  ...
  UPDATE_ORGANIZATION: (orgId) => ({url:`${BASE_URL}/organization/update?org_id=${orgId}`,headers: authHeaders}),
  FETCH_ORGANIZATION: (orgId) => ({url: `${BASE_URL}/organization/getbyid?org_id=${orgId}`,headers: authHeaders}),
  ...
  GET_DEPARTMENTACTIVE: {url: `${BASE_URL}/department/getactive`,headers: authHeaders},
  FETCH_DEPARTMENT: (deptId) => ({url: `${BASE_URL}/department/getbyid?dept_id=${deptId}`,headers: authHeaders}),
  DELETE_DEPARTMENT:(deleteId) => ({url:`${BASE_URL}/department/delete?dept_id=${deleteId}`,headers: authHeaders}),
  CSV_DEPARTMENT: {url:`${BASE_URL}/department/uploadcsv`,headers: authHeaders},
  UPDATE_DEPARTMENT: (deptId) => ({url:`${BASE_URL}/department/update?dept_id=${deptId}`,headers: authHeaders}),
  ...
  FETCH_ADMIN: (adminId) => ({url: `${BASE_URL}/user/getbyid?user_id=${adminId}`,headers:authHeaders}),
  UPDATE_ADMIN: (adminId) => ({url: `${BASE_URL}/user/update?user_id=${adminId}`,headers:authHeaders}),
  ...
  //GRIEVANCE JE
  GET_GRIEVANCEJE: (code) => ({url: `${BASE_URL}/new-grievance/getbyassign?assign_user=${code}`,headers:authHeaders}),
  GET_GRIEVANCEJE: {url: `${BASE_URL}/status/get`,headers:authHeaders},
  FETCH_GRIEVANCEJE: (grievanceId) => ({url: `${BASE_URL}/new-grievance/getbyid?grievance_id=${grievanceId}`,headers:authHeaders}),
  FETCH_GRIEVANCEJE: (responseData) => ({url: `${BASE_URL}/new-grievance/filter?zone_name=${responseData.zone_name}`,headers:authHeaders}),
  FETCH_GRIEVANCEJE: (responseData) => ({url: `${BASE_URL}/new-grievance/getbyid?ward_name=${responseData.ward_name}`,headers:authHeaders}),
  FETCH_GRIEVANCEJE: (responseData) => ({url: `${BASE_URL}/new-grievance/getbyid?street_name=${responseData.street_name}`,headers:authHeaders}),
  FETCH_GRIEVANCEJE: (responseData) => ({url: `${BASE_URL}/new-grievance/getbyid?dept_name=${responseData.dept_name}`,headers:authHeaders}),
  FETCH_GRIEVANCEJE: (responseData) => ({url: `${BASE_URL}/new-grievance/getbyid?complaint=${responseData.complaint}`,headers:authHeaders}),
  FETCH_GRIEVANCEJE: (grievanceId) => ({url: `${BASE_URL}/new-grievance-attachment/getattachments?grievance_id=${grievanceId}`,headers:authHeaders}),
  FETCH_GRIEVANCEJE: (grievanceId) => ({url: `${BASE_URL}/grievance-log/getbyid?grievance_id=${grievanceId}`,headers:authHeaders}),
  UPDATE_GRIEVANCE: (grievanceId) => ({url: `${BASE_URL}/new-grievance/updatestatus?grievance_id=${grievanceId}`,headers:authHeaders}),
  POST_GRIEVANCEJE: {url:`${BASE_URL} /grievance-log/post`,headers:authHeaders},
  POST_GRIEVANCEJE: {url:`${BASE_URL} /grievance-worksheet/post`,headers:authHeaders},
  POST_GRIEVANCEJE: {url:`${BASE_URL}/grievance-worksheet-attachment/post`,headers:authHeaders},

  //GRIEVANCE 
  GET_GRIEVANCE: {url:`${BASE_URL}/new-grievance/get`,headers:authHeaders},
  GET_GRIEVANCE: {url:`${BASE_URL}/status/get`,headers:authHeaders},
  FETCH_GRIVANCE: (contactNumber)=>({url: `${BASE_URL}/public-user/getbyphone?phone=${contactNumber}`,headers:authHeaders}),
  POST_GRIEVANCE: {url:`${BASE_URL}/public-user/post`,headers:authHeaders},
  POST_GRIEVANCE: {url:`${BASE_URL}/new-grievance/post`,headers:authHeaders},
  POST_GRIEVANCE: {url:`${BASE_URL}/new-grievance-attachment/post`,headers:authHeaders},

  //GRIEVANCE ADMIN:
  FETCH_GRIEVANCEADMIN: (dept)=>({url: `${BASE_URL}/user/getbydept?dept_name=${dept}`,headers:authHeaders}),
  POST_GRIEVANCEADMIN: {url: `${BASE_URL}/new-grievance/updatemanyassign`,headers:authHeaders},
  ...
  UPDATE_STREET: (streetId)=>({url: `${BASE_URL}/street/update?street_id=${streetId}`, headers:authHeaders}),
 
  //WARD
  DELETE_WARD: (deleteId) => ({url: `${BASE_URL}/ward/delete?ward_id=${deleteId}`,headers:authHeaders}),
  UPLOAD_WARD: {url: `${BASE_URL}/ward/uploadcsv`,headers:authHeaders},
  FETCH_WARD: (wardId)=>({url: `${BASE_URL}/ward/getbyid?ward_id=${wardId}`,  headers:authHeaders}),
  UPDATE_WARD: (wardId)=>({url: `${BASE_URL}/ward/update?ward_id=${wardId}`, headers:authHeaders}),
 
   //ZONE
   DELETE_WARD: (deleteId) => ({url: `${BASE_URL}/zone/delete?zone_id=${deleteId}`,headers:authHeaders}),
   UPLOAD_WARD: {url: `${BASE_URL}/zone/uploadcsv`,headers:authHeaders},
   FETCH_WARD: (zoneId)=>({url: `${BASE_URL}/zone/getbyid?zone_id=${zoneId}`,  headers:authHeaders}),
   UPDATE_WARD: (zoneId)=>({url: `${BASE_URL}/zone/update?zone_id=${zoneId}`, headers:authHeaders}),
  
  //PUBLIC USER:
  GET_PUBLICUSER: {url:`${BASE_URL}/public-user/get`,headers:authHeaders},
  DELETE_WARD: (deleteId) => ({url: `${BASE_URL}/public-user/delete?public_user_id=${deleteId}`,headers:authHeaders}),
  UPLOAD_STREET: {url: `${BASE_URL}/public-user/uploadcsv`,headers:authHeaders},
  FETCH_WARD: (userId)=>({url: `${BASE_URL}/public-user/getbyid?public_user_id=${userId}`, headers:authHeaders}),
  UPDATE_WARD: (userId)=>({url: `${BASE_URL}/public-user/update?public_user_id=${userId}`, headers:authHeaders}),

  //REQUEST
  ATTACHMENT_REQUEST:(attachmentFile) => ({url: `${BASE_URL}/new-grievance-attachment/file/${attachmentFile}`,headers:authHeaders}),
  FETCH_REQUEST: (grievanceId) => ({url: `${BASE_URL}/new-grievance-attachment/getattachments?grievance_id=${grievanceId}`,headers:authHeaders}),
  FETCH_REQUEST: (grievanceId)=>({url: `${BASE_URL}/grievance-log/getbyid?grievance_id=${grievanceId}`, headers:authHeaders}),

  //STATUS
  DELETE_STATUS: (deleteId) => ({url: `${BASE_URL}/status/delete?status_id=${deleteId}`,headers:authHeaders}),
  FETCH_STATUS:(status_id)=>({url: `${BASE_URL}/status/getbyid?status_id=${status_id}`, headers:authHeaders}),
  UPDATE_WARD: (status_id)=>({url: `${BASE_URL}/status/update?status_id=${status_id}`, headers:authHeaders}),
